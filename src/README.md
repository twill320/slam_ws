...
* `slam_bot_description` - holds the sdf description of the simulated system and any other assets.

* `slam_bot_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `slam_bot_application` - holds ros2 specific code and configurations.

* `slam_bot_bringup` - holds launch files and high level utilities.
...
1. Launch the simulation
    ...
    ```bash
    ros2 launch slam_bot_bringup diff_drive.launch.py
    ```
